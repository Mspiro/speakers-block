(function (Drupal) {
  ...
  Drupal.behaviors.speakersBlock = {
    attach: function (context, settings) {
      const splideElements = context.querySelectorAll(
        '.speakers-carousel:not(.is-initialized)',
      );
      ...
      const speakerCards = context.querySelectorAll(
        '.speaker-card:not(.is-processed)',
      );
      ...
      speakerCards.forEach((card) => {
        ...
        card.addEventListener('click', function () {
          ...
          modal.querySelector('#modal-designation').innerHTML =
            data.designation;
          ...
          modal.querySelector('#social-linkedin').href =
            data.socialLinkedin.trim();
